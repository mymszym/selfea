...
TRAIN_ILL_RATE = 0.2  # training data rate. Example: train ILL number: 11199 * 0.2 = 2239.
...
DATA_PATH = r"../data/FBYG15K/norm/"
Translated = False
ISNAME = False

# DES_DICT_PATH = '../data/dbp15k/translated_description' if Translated else '../data/dbp15k/2016-10-des_dict'  # description data path
DES_DICT_PATH = '../data/FBYG15K/norm/fbygdesc'

Image_feature_path = "../data/EAKpkls/FBYG15K_id_img_feature_dict.pkl"
